<form method="POST" action="{{ route('update_office', [$office->id])}}">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" required
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <textarea name="location_link" id="location_link" class="form-control @error('location_link') is-invalid @enderror" required
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <textarea name="hours" id="hours" class="form-control @error('hours') is-invalid @enderror" required
